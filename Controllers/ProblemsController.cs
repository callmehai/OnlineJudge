...
namespace OnlineJudge.Controllers
{
    public class ProblemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,TimeLimitMs,MemoryLimitMb")] Problem problem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,TimeLimitMs,MemoryLimitMb")] Problem problem)
        {
            if (id != problem.Id)
            {
                return NotFound();
